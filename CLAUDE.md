...
## 技術スタック
- Python 3.12
- Terraform (Lambda + API Gateway + Aurora PostgreSQL)
- Claude API (anthropic)
- PostgreSQL 16 (Aurora Serverless v2 / ローカルはDockerコンテナ)
...
## 開発環境
- Docker Compose で開発（`docker compose up -d` でアプリ＋PostgreSQL起動）
